...
const App: ParentComponent = (props) => {
    const navClasses = 'gap-x-5 text-blue-400 text-base font-bold hover:text-gray-300'
    return (
        <div class={styles.App}>
            ...
            <footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800 max-w-screen-xl mx-auto">
                <div
                    ...
                    <div>
                        Built by WireMock, based on the Train Travel API spec by <a href="https://bump.sh/">Bump.sh</a>
                    </div>
                </div>
            </footer>
        </div>
